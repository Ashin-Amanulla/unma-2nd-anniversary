...
const RegistrationPending = () => {
  ...
  const { school, name, email, contactNumber } = location.state || {};
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      A representative from {school} will contact you shortly
                      to:
                    </p>
                    <ul className="list-disc list-inside mt-2">
                      <li>Discuss your registration details</li>
                      <li>Help complete your registration process</li>
                      <li>Address any concerns you may have</li>
                    </ul>
                  </div>
                </div>
              </div>
